...
use Exporter 'import';
our @EXPORT_OK = qw(stringify destringify dir_revhash parse_cmdline_options find_submodules load_file_or_module split_for_bash go_figure_dbc go_figure_dba find_dba_in_registry report_versions throw join_command_args whoami);
            ...
            eval {
                ...
                if($reg_type) {
                    ...
                    if( scalar(@$dbas) == 1 ) {
                        ...
                        die "The registry contains multiple entries for '$foo', please prepend the foo with the desired type (one of '$groups')";
                    }
                }
            }
}
